...
(function() {
     ...
     */
    GitHubClient.prototype.extension = '.dfd';
    ...
    GitHubClient.prototype.showCommitDialog = function(filename, isNew, success, cancel) {
        ...
        var dlg = new FilenameDialog(this.ui, mxResources.get((isNew) ? 'addedFile' : 'updateFile', [filename]), mxResources.get('ok'), mxUtils.bind(this, function(message) {
            resume();
            success(message);
